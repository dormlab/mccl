...
def register() -> bool:
    ...
    # Disable torch's MPS commitAndContinue: with it on, torch reuses
    # MPSCommandBuffer across commits and MPSGraph encoding races with
    # mccl's cross-thread MPSEvent record, tripping MPSPredicate. Must
    # be set before any torch.mps API.
